...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if ($updateStmt->execute()) {
        ...
        $_SESSION['error_message'] = "Error updating student user. Please try again.";
    }
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1><?php echo htmlspecialchars($student['lastName']); ?>'s Data</h1>
					<ul class="breadcrumb">
						<li>
							<a href="#">Home</a>
						</li>
                        ...
                        <li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="active" href="edit_student.php?userID=<?php echo $student['userID']; ?>">Edit</a>
						</li>
					</ul>
				</div>
				<a href="./data_student.php" class="back-button">
			  ...
			  <form method="POST" class="edit-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contactNumber" value="<?php echo htmlspecialchars($student['contactNumber']); ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="birthday" id="birthday" value="<?php echo htmlspecialchars($student['birthday']); ?>" required>
                </div>

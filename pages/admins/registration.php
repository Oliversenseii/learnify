    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Register Teacher and Student</h1>
                    <ul class="breadcrumb">
                        <li><a href="#">Home</a></li>
            ...
            <div class="form-container">
                <h3 class="title-user">Register Teacher and Student</h3>
                <form action="registration.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select name="userType" id="userType" placeholder=" ">
                                ...
                                <option value="Professor" <?php echo $userType == 'Professor' ? 'selected' : ''; ?>>Teacher</option>
                        ...
                        <div class="form-group">
                            <div class="icon-container"><i class="fa-solid fa-venus-mars"></i></div>
                    ...
                    <div class="form-actions">
                        <button class="btn-download" id="btn-download" type="submit" name="registerUser">Register</button>
                    </div>
                </form>
            </div>
        </main>
            ...
            function updateLabelAndPlaceholder() {
                ...
                if (userType) {
                    ...
                    if (userType === 'SuperAdmin' || userType === 'Admin') {
                        ...
                        lrnLabel.textContent = 'Teacher ID (5-Digit Number)';
                        lrnInput.placeholder = ' ';
                    } else if (userType === 'Student') {
                        lrnLabel.textContent = 'LRN (12-Digit Number)';
                        lrnInput.placeholder = ' ';
                    }
                } else {

...
try {
    ...
    // Calculate totals
    $totalManual = $loginMethodCounts['admins']['manual'] + $loginMethodCounts['professors']['manual'] + $loginMethodCounts['students']['manual'];
    $totalQRCode = $loginMethodCounts['admins']['qr'] + $loginMethodCounts['professors']['qr'] + $loginMethodCounts['students']['qr'];
...
<head>
    ...
    <title>Learnify Login Method Distribution Report</title>
        ...
        <div class="report-container" id="report">
            <div class="report-border">
                <div class="report-header">
                    <h1>Learnify Login Method Distribution Report</h1>
                </div>
                <div class="report-content">
                    <h2>Login Method Distribution</h2>
                    <table class="report-table">
                        <tr>
                            <th>User Type</th>
                            <th>Manual Logins</th>
                            <th>QR Code Logins</th>
                        </tr>
                        <tr>
                            <td>Admins</td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['admins']['manual']); ?></td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['admins']['qr']); ?></td>
                        </tr>
                        <tr>
                            <td>Teachers</td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['professors']['manual']); ?></td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['professors']['qr']); ?></td>
                        </tr>
                        <tr>
                            <td>Students</td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['students']['manual']); ?></td>
                            <td><?php echo htmlspecialchars($loginMethodCounts['students']['qr']); ?></td>
                        </tr>
                        <tr>
                            <td>Total</td>
                            <td><?php echo htmlspecialchars($totalManual); ?></td>
                            <td><?php echo htmlspecialchars($totalQRCode); ?></td>
                        </tr>
                    </table>
                </div>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                try {
                    html2pdf()
                        .set({
                            margin: [3, 3, 3, 3],
                            filename: 'Learnify_Login_Method_Report_<?php echo $safeAdminName; ?>_<?php echo date('Ymd_His'); ?>.pdf',

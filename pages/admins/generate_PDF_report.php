...
try {
    ...
    $stmt = $dbConnection->prepare("
        ...
        WHERE ss.archived = 0 AND u.userType = 'Student'
    ");
    $stmt->execute();
    ...
    // Generate narrative
    $narrative = "This report summarizes Learnify's user base and academic structure.\n";
    $narrative .= "Total Users: $totalUsers (Admins: {$counts['admins']}, Professors: {$counts['professors']}, Students: {$counts['students']})\n";
    $narrative .= "Structure: Tracks & Strands: $strandCount, Sections: $sectionCount, Modules: $moduleCount, Subjects: $subjectCount\n";
    $narrative .= "Enrollments: $enrollmentCount";
    if ($enrollmentCount > 0) {
        $narrative .= " (Active enrollments recorded)";
    } else {
            ...
            <div class="report-container" id="report">
                <div class="report-border">
                    ...
                    <div class="report-content">
                        ...
                        <p>Generated by: <?php echo htmlspecialchars($_SESSION['firstName']); ?> (Admin)</p>
                        ...
                        <h3>Enrollments</h3>
                        <p><strong>Total Enrollments: <?php echo htmlspecialchars($enrollmentCount); ?></strong></p>
                        ...
                        <div class="signature-section">
                            <div class="signature-line">
                                <div class="signature-graphic">Admin <br><span class="name"><?php echo htmlspecialchars(strtoupper($_SESSION['firstName'])); ?></span></div>
    ...
    $_SESSION['error'] = "Database error: Unable to generate report.";

...
try {
    ...
    $stmt = $dbConnection->prepare("
        SELECT firstName, lastName, middleName, userType, image, status
        FROM users
        WHERE userID = :userID
        LIMIT 1
    ");
...
<head>
    ...
    <title>Learnify - Professor Status</title>
    ...
    <section id="content">
        <main>
            <div class="status-container" id="status">
                <h1 class="status-header">Account Status</h1>
                ...
                <div class="status-icon <?php echo strtolower($status); ?>">
                    <i class='bx <?php echo $status === 'Pending' ? 'bx-hourglass' : 'bx-x-circle'; ?>'></i>
                </div>
                <p class="status-message <?php echo strtolower($status); ?>">
                    Your account status is currently <strong><?php echo htmlspecialchars($status); ?></strong>.
                    <?php if ($status === 'Pending'): ?>
                        Please wait for admin approval to access your dashboard and classes.
                    <?php elseif ($status === 'Inactive'): ?>
                        Please contact the IT administrator for more details.
                    <?php endif; ?>
                </p>
            </div>
            <div class="faq-container" id="faqs">
                <h1 class="faq-header">Frequently Asked Questions</h1>
                <p class="faq-subtitle">Common questions about account status</p>
                <!-- <div class="faq-item">
                    <h3>What does "Pending" status mean?</h3>
                    <p>A "Pending" status means your account is under review by the administrator. You will be notified once it is approved.</p>
                </div> -->
                <div class="faq-item">
                    <h3>What should I do if my status is "Inactive"?</h3>
                    <p>If your status is "Inactive," please contact the IT administrator via email or phone for further details and assistance.</p>
                </div>
                <div class="faq-item">
                    <h3>How long does it take to get approved?</h3>
                    <p>Approval times vary, but typically it takes 1-3 business days. Contact the IT administrator if you have urgent questions.</p>
                </div>
            </div>
            <div class="profile-container" id="profile">
                ...
                <div class="profile-item">
                    ...
                    <p>You can update your name, email, and other details by contacting the administrator or through your dashboard once your account is active.</p>
                </div>
                <div class="profile-item">
                    <h3>Change Profile Picture</h3>
                    <p>Upload a new profile picture to personalize your account. This feature is available once your account is active.</p>
                </div>
            </div>
        </main>
    </section>

...
if (empty($file) || !file_exists("../../pages/admins/modules/$file")) {
...
$file_url = 'http://' . $_SERVER['HTTP_HOST'] . '/capstone-lms/pages/admins/modules/' . $file;
...
<body>
    <div class="modal-container" id="modal-container">
        <div class="modal-header">
            ...
            <div class="button-group">
                ...
                <?php endif; ?>
                <a href="./data_modules.php" class="close-button">
                    <i class='bx bx-x'></i>
                </a>
            </div>
        </div>
        <div class="modal-content">
            <?php if ($is_pdf): ?>
                <embed id="file-embed" src="../../pages/admins/modules/<?php echo htmlspecialchars($file); ?>" type="application/pdf">
            <?php elseif ($is_image): ?>
                <img id="file-embed" src="../../pages/admins/modules/<?php echo htmlspecialchars($file); ?>" alt="Image Preview">
            <?php elseif ($is_video): ?>
                <video id="file-embed" controls>
                    <source src="../../pages/admins/modules/<?php echo htmlspecialchars($file); ?>" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            <?php elseif ($is_audio): ?>
                <audio id="file-embed" controls>
                    <source src="../../pages/admins/modules/<?php echo htmlspecialchars($file); ?>" type="<?php echo htmlspecialchars($mime_types[$extension]); ?>">
                    Your browser does not support the audio tag.
                </audio>
            <?php elseif ($extension === 'csv'): ?>
                <div class="table-content">
                    <?php echo renderCsvTable("../../pages/admins/modules/$file"); ?>
            ...
            <?php elseif ($is_text): ?>
                <div class="text-content">
                    <pre><?php echo htmlspecialchars(file_get_contents("../../pages/admins/modules/$file")); ?></pre>
                    <a href="javascript:void(0);" onclick="downloadFile('<?php echo htmlspecialchars($file_url); ?>', '<?php echo htmlspecialchars($file); ?>')" class="download-link">
                        <i class='bx bxs-download'></i> Download File
                    </a>
                </div>
    ...
    <script>
        ...
        <?php if ($extension === 'docx'): ?>
            ...
            fetch("../../pages/admins/modules/<?php echo htmlspecialchars($file); ?>")
                .then(response => {
                    if (!response.ok) {

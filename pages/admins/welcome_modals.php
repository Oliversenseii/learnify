...
<?php if (!$hasSeenModals): ?>
    ...
    <div id="welcomeOverlay2" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/admin-dash.png" alt="Dashboard Image" class="overlay-image">
            <div class="content-section">
                <h2>📒 Dashboard Overview 📒</h2>
                <p>Your dashboard is your central hub for managing teachers, students, subjects,
                 Track and Strands, and Sections, while also monitoring detailed analytics. Each chart is displayed in its own box, and you can generate a PDF report for each one.</p>
            </div>
    ...
    <div id="welcomeOverlay3" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/step3.png" alt="Security Image" class="overlay-image">
            <div class="content-section">
                <h2>📈 Analytics 📉</h2>
                <p>This is a sample of the analytics. You can easily generate a report by clicking the 'Download' button.</p>
            </div>
    ...
    <div id="welcomeOverlay4" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/step4.png" alt="Urgent Password Change Image" class="overlay-image">
            <div class="content-section">
                <h2>📂 Generate PDF Reports 📂</h2>
                <p>After clicking, you can view the full report and download it as a PDF.</p>
            </div>
            <form method="post" action="./adminDash.php" class="overlay-actions">

...
try {
    ...
    $changelog = [
        "1.0.0" => [
            ...
            "new_features" => [
                "Initial release of Learnify LMS for Admin",
                "Dashboard with total tally and analytics for all users except SuperAdmin",
                "Generate CSV and PDF reports for system data",
                "Bulk upload functionality for registering teacher and students",
                "Manage Tracks, Strands, Subjects, and Sections",
            ...
            "removed_features" => [],
            "security_patches" => [
                "Implemented secure session handling for Admin",
            ...
            "release_notes" => "Initial release with core Admin features, including user management, section enrollment, and reporting. Enhanced security via bcrypt hashing, session persistence, and auto-logout."
        ]
    ];

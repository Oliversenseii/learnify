...
<?php if (!$hasSeenModals): ?>
    ...
    <div id="welcomeOverlay1" class="welcome-overlay" style="display: flex;">
        <div class="overlay-container">
            ...
            <div class="content-section">
                ...
                <p>Welcome to your student dashboard. Let's take a quick tour to get you started.</p>
            </div>
    ...
    <div id="welcomeOverlay2" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/dashboard.png" alt="Dashboard Image" class="overlay-image">
            <div class="content-section">
                <h2>📒 Dashboard Overview 📒</h2>
                <p>Your dashboard is your hub for classes, schedules, quizzes, assignments, and announcements.</p>
            </div>
    ...
    <div id="welcomeOverlay3" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/password-sec.png" alt="Security Image" class="overlay-image">
            <div class="content-section">
    ...
    <div id="welcomeOverlay4" class="welcome-overlay" style="display: none;">
        <div class="overlay-container">
            <!-- <button class="close-button" onclick="closeOverlay()">×</button> -->
            <img src="./welcome/dashboard/change-pass.png" alt="Urgent Password Change Image" class="overlay-image">
            <div class="content-section">
                <h2>📝 Change Password Now 📝</h2>
                <p>We strongly recommend updating your password immediately for security. Do it now?</p>
            </div>
            <form method="post" action="./studentDash.php" class="overlay-actions">

...
try {
    $stmt = $dbConnection->prepare("SELECT firstName, middleName, lastName, birthday, sex, address, email, contactNumber, nationality, image, status, lrn FROM users WHERE userID = :userID");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['saveChanges'])) {
        ...
        try {
            $stmt = $dbConnection->prepare("UPDATE users SET firstName = :firstName, middleName = :middleName, lastName = :lastName, birthday = :birthday, sex = :sex, address = :address, email = :email, contactNumber = :contactNumber, nationality = :nationality, image = :image, status = :status, lrn = :lrn WHERE userID = :userID");
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a class="active" href="./userAcc2.php">Edit</a></li>
                    </ul>
                </div>
                <a href="./main_acc.php" class="back-button"><i class='bx bx-arrow-back'></i> Back to Account</a>
            </div>
            ...
            <div class="form-wrapper">
                <div class="form-container">
                    <form action="userAcc2.php" method="POST" enctype="multipart/form-data">

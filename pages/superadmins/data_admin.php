    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Administrators<?php echo ($valid_sex || $valid_age_group) ? ' (' . ($valid_sex ? ucfirst($valid_sex) : '') . ($valid_sex && $valid_age_group ? ', ' : '') . ($valid_age_group ? 'Age ' . $valid_age_group : '') . ')' : ''; ?></h1>
                    <ul class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a class="active" href="data_admin.php">Administrators</a></li>
                    </ul>
                </div>
            ...
            <?php if ($valid_sex || $valid_age_group): ?>
                <div class="filter-notification">
                    ...
                    <?php echo $valid_age_group ? 'Age ' . $valid_age_group : ''; ?> Admins
                </div>
            <?php endif; ?>
            ...
            <form method="GET" class="search-form">
                ...
                <?php if (!empty($search) || $valid_sex || $valid_age_group): ?>
                    <a href="data_admin.php" class="clear-btn">Clear</a>
                <?php endif; ?>
                <?php if ($valid_sex): ?>
                        ...
                        <?php if (!empty($admins)): ?>
                            ...
                            <?php foreach ($admins as $admin): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_admin.php?userID=<?php echo encryptID($admin['userID']); ?>" class="btn-edit">
                                            <i class='bx bxs-edit'></i> Edit
                                        </a>
                                        <!-- <a href="archive_admin.php?userID=<?php echo encryptID($admin['userID']); ?>" class="btn-archive" onclick="return confirm('Are you sure you want to archive this admin?');">

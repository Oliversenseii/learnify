...
// Separate main account and other admins
$mainAccount = [];
$otherAdmins = [];
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>SuperAdmins<?php echo ($valid_sex || $valid_age_group) ? ' (' . ($valid_sex ? ucfirst($valid_sex) : '') . ($valid_sex && $valid_age_group ? ', ' : '') . ($valid_age_group ? 'Age ' . $valid_age_group : '') . ')' : ''; ?></h1>
                    <ul class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li><a class="active" href="data_superAdmin.php">SuperAdmins</a></li>
                    </ul>
                </div>
            ...
            <?php if ($valid_sex || $valid_age_group): ?>
                <div class="filter-notification">
                    ...
                    <?php echo $valid_age_group ? 'Age ' . $valid_age_group : ''; ?> SuperAdmins
                </div>
            <?php endif; ?>
            ...
            <form method="GET" class="search-form">
                ...
                <?php if (!empty($search) || $valid_sex || $valid_age_group): ?>
                    <a href="data_superAdmin.php" class="clear-btn">Clear</a>
                <?php endif; ?>
                <?php if ($valid_sex): ?>
                ...
                <div class="admin-table">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?php if ($mainAccount['image']): ?>
                                        <img src="<?php echo htmlspecialchars($mainAccount['image']); ?>" alt="Profile Image" class="profile-img">
                                    <?php else: ?>
                                        <img src="./img/noprofile.png" alt="No Profile Image" class="profile-img">
                                    <?php endif; ?>
                                </td>
                                <td><?php echo htmlspecialchars($mainAccount['firstName'] . ' ' . $mainAccount['lastName']); ?></td>
                                <td><?php echo htmlspecialchars($mainAccount['email']); ?></td>
                                <td><?php echo calculateAge($mainAccount['birthday']); ?></td>
                                <td>
                                    <p class="<?php echo strtolower($mainAccount['status']) === 'active' ? 'status-active' : 'status-inactive'; ?>">
                                        <?php echo htmlspecialchars($mainAccount['status']); ?>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="admin-table">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5">
                                    No account found<?php echo $valid_sex ? ' for ' . strtolower($valid_sex) : ''; ?>
                                    <?php echo $valid_age_group ? ' in age group ' . $valid_age_group : ''; ?>
            ...
            <!-- Other SuperAdmins Section -->
            <h3 class="section-title">Other SuperAdmins</h3>
            <div class="admin-table">
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if (!empty($otherAdmins)): ?>
                            ...
                            <?php foreach ($otherAdmins as $admin): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($admin['image']): ?>
                                            <img src="<?php echo htmlspecialchars($admin['image']); ?>" alt="Profile Image" class="profile-img">
                                        <?php else: ?>
                                            <img src="./img/noprofile.png" alt="No Profile Image" class="profile-img">
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td><?php echo calculateAge($admin['birthday']); ?></td>
                                    <td>
                                        <p class="<?php echo strtolower($admin['status']) === 'active' ? 'status-active' : 'status-inactive'; ?>">
                                            <?php echo htmlspecialchars($admin['status']); ?>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="edit_superAdmin.php?userID=<?php echo encryptID($admin['userID']); ?>" class="btn-edit">
                                            <i class='bx bxs-edit'></i> Edit
                                        </a>
                                        <a href="archive_superAdmin.php?userID=<?php echo encryptID($admin['userID']); ?>" class="btn-archive" onclick="return confirm('Are you sure you want to archive this admin?');">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7">
                                    No other SuperAdmins found
                                    <?php echo $valid_sex ? ' for ' . strtolower($valid_sex) : ''; ?>
                                    <?php echo $valid_age_group ? ' in age group ' . $valid_age_group : ''; ?>
                                    <?php echo $search !== '' ? ' matching "' . htmlspecialchars($search) . '"' : ''; ?>.
                                </td>
                            </tr>

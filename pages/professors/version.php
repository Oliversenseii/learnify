...
try {
    ...
    $changelog = [
        "1.0.0" => [
            ...
            "new_features" => [
                "Initial release of Learnify LMS for Teacher",
                "Manage handled classes with section and subject details",
                "Create and manage course modules",
                "Track student attendance for assigned classes",
                "Create and grade quizzes and assignments",
                "Post announcements for classes",
                "Manage comments and private messages with students",
            ...
            "removed_features" => [],
            "security_patches" => [
                "Implemented secure session handling for Teacher",
            ...
            "release_notes" => "Initial release with core Professor Teacher, including class management, module creation, attendance tracking, quizzes, assignments, announcements, and messaging. Enhanced security via bcrypt hashing, session persistence, and auto-logout."
        ]
    ];
                    ...
                    <?php foreach ($changelog as $version => $details): ?>
                        ...
                        <?php if (!empty($details['new_features'])): ?>
                            <div class="category new-features">
                                ...
                                <?php endforeach; ?>
                                <h5>GAMIFICATION</h5>
                                <div class="feature-card gamification-item"><strong>LEARNIFY QUIZZIZ:</strong> Create interactive quizzes with unique codes, allowing students to compete in timed multiple-choice challenges, earning points and ranking on a leaderboard with medals for top performers.</div>
                            </div>
                        <?php endif; ?>
